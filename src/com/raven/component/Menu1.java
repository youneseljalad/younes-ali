...
public class Menu1 extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "search for a book", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "hitorique", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "log out", Model_Menu.MenuType.MENU));
